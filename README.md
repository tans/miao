...
创意喵是一个连接商家和创作者的任务平台，商家可以发布创意任务，创作者可以认领任务并获得报酬。平台采用等级制度和信用体系，保障双方权益。
...
### 核心机制
- 🔒 **保证金制度**: 青铜创作者需冻结10元保证金
- 📊 **等级升级**: 基于总积分和完成订单数自动升级
- 💰 **动态抽成**: 等级越高抽成越低（10%-20%）
...
| 等级 | 总积分 | 完成订单 | 每日限额 | 抽成比例 |
|------|--------|---------|---------|---------|
| 青铜 | 0-199 | - | 3单 | 20% |
| 白银 | 200-499 | ≥10 | 10单 | 15% |
| 黄金 | 500-999 | ≥50 | 20单 | 12% |
| 钻石 | ≥1000 | ≥100 | 50单 | 10% |

**积分计算**:
- 行为积分: 初始100分，违规扣分
- 交易积分: 每1元交易额 = 0.1分（最高500分）
- 总积分 = 行为积分 + 交易积分
