...
var (
	// DefaultRateLimiter is the default rate limiter (100 requests per minute)
	DefaultRateLimiter = NewRateLimiter(100, time.Minute)

	// StrictRateLimiter is a stricter rate limiter (20 requests per minute)
	StrictRateLimiter = NewRateLimiter(20, time.Minute)
)
